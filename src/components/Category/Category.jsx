    ...
    return (
      ...
      <div key={card.id} className="flex-1 basis-[300px]  ">
        ...
        <div className=" bg-zinc-100 pt-17 p-8 rounded-xl">
          ...
          <Link to={card.path} className=" bg-gradient-to-b from-orange-400 to-orange-500 text-white px-8 py-3 rounded-lg md:text-lg text-md tegt-=,md hover:scale-105 hover:to-orange-600 transition-all duration-300 cursor-pointer" >
            See All
          </Link>
        </div>
      </div>
